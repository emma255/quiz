...
var SELECTOR_TAB_NAV = "".concat(SELECTOR_CONTENT_WRAPPER, ".iframe-mode .nav");
var SELECTOR_TAB_NAVBAR_NAV = "".concat(SELECTOR_CONTENT_WRAPPER, ".iframe-mode .navbar-nav");
...
var SELECTOR_TAB_CONTENT = "".concat(SELECTOR_CONTENT_WRAPPER, ".iframe-mode .tab-content");
...
var IFrame = /*#__PURE__*/function () {
  ...
  _createClass(IFrame, [{
    ...
    value: function _init() {
      ...
      if (usingDefTab) {
        var $el = jquery__WEBPACK_IMPORTED_MODULE_0___default()("".concat(SELECTOR_TAB_PANE)).first(); // eslint-disable-next-line no-console
...
/******/ 	__webpack_require__.O(undefined, ["css/adminlte.min"], () => (__webpack_require__("./resources/js/AdminLTE.js")))
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/adminlte.min"], () => (__webpack_require__("./resources/scss/AdminLTE.scss")))
